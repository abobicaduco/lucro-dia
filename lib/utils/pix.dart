...
class Pix {
  ...
  /// CRC16-CCITT (polinômio 0x1021, init 0xFFFF) sobre o payload + "6304".
  ...
  static String copiaECola({
    ...
    final payload = StringBuffer()
      ..write(_campo('00', '01')) // formato
      ..write(_campo('01', '11')) // estático/reutilizável
      ..write(mai)
      ..write(_campo('52', '0000')) // categoria
      ..write(_campo('53', '986')) // moeda BRL
      ..write(_campo('58', 'BR')) // país
      ..write(_campo('59', nome))
      ..write(_campo('60', municipio))
      ..write(adicional)
      ..write('6304'); // marcador do CRC
